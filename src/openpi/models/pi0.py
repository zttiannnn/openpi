...
class Pi0(_model.BaseModel):
    ...
    ) -> tuple[_model.Observation, at.Float[at.Array, "b s emb"], at.Bool[at.Array, "b s"], object]:
    ...
    def sample_actions(
        ...
        *,
        ...
        def step(carry):
            x_t, time = carry
            v_t = self._denoise_step_from_cache(observation, prefix_tokens, prefix_mask, kv_cache, x_t, time)
