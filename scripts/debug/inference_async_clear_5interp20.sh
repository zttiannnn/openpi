...
echo "Running THOR low-delay async baseline: 5Hz policy, action_steps=20, send_fps=20, no RTC, have horizon smoothing"
...
python scripts/inference_smooth_0912.py \
  ...
  --dump_chunk_handoff_dir scripts/debug/chunk_handoff_dumps_async_clear_5interp20_30000
