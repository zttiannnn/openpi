...
echo "Running raw_prefix_paper RTC: w=22 sigma_d=0.25"
...
python scripts/inference_smooth_0912.py \
  ...
  --horizon_smooth none \
  --rtc_enable \
  --rtc_guidance_mode executed_overlap_paper \
  --rtc_schedule auto \
  --rtc_max_guidance_weight 22.0 \
  --rtc_sigma_d 0.25 \
  ...
  --dump_chunk_handoff_dir scripts/debug/chunk_handoff_dumps_async_exec_rtc_w22_sd025_30000_5interp20
