...
python scripts/inference_smooth_0912.py \
  ...
  --rtc_stay_weight 0.0 \
  --rtc_b1_guided_delta_abs_max 6000000.0 \
  ...
  --profile_model_output_json openpi/scripts/debug/profile_rtc_max.json \
  --profile_model_output_csv openpi/scripts/debug/profile_rtc_max.csv \
