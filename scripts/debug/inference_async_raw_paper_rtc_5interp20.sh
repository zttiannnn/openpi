...
echo "Running THOR async raw-prefix paper RTC comparison: 5Hz policy + 20Hz send interp, no horizon smoothing"
...
python scripts/inference_smooth_0912.py \
  ...
  --dump_chunk_handoff_dir scripts/debug/chunk_handoff_dumps_async_raw_rtc_20hz_20step_30000_5interp20
