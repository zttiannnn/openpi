...
echo "Running THOR async B1 comparison: 20Hz, action_steps=20, executed_prefix_b1 + EMA horizon smoothing"
...
python scripts/inference_smooth_0912.py \
  ...
  --dump_chunk_handoff_dir scripts/debug/chunk_handoff_dumps_async_b1_20hz_20step_9000
