...
echo "Running raw_prefix_paper RTC: w=30 sigma_d=0.25"
...
python scripts/inference_smooth_0912.py \
  ...
  --dump_chunk_handoff_dir scripts/debug/chunk_handoff_dumps_async_raw_paper_rtc_w30_sd025_30000_5interp20
